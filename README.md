...
Notes: As per 2019-03-11 the [original repository](https://github.com/jpmens/mosquitto-auth-plug) was archived by its owner. He has end working on that project due to some circumstances. Each change from my side will be done on this fork.
